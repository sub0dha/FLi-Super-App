        ...
        {isMenuOpen && (
          <div className="nav-mobile">
            <ul className="mobile-links">
              ...
              <li>
                <a href="/products" className="mobile-link" onClick={toggleMenu}>
                  Products
                </a>
              </li>
              <li>
                <a href="/categories" className="mobile-link" onClick={toggleMenu}>
                  Categories
                </a>
              </li>
              <li>
                <a href="/offers" className="mobile-link" onClick={toggleMenu}>
                  Special Offers
                </a>
              </li>
              <li>
